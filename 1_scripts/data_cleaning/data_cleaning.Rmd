...
```{r}
# community composition data 2023 (long)
community_2023 <- read_csv("2_data/1_raw_data/community_composition/vp_pp_2023_l_fn.csv") %>% 
...
## taxonomic data 
```{r}
checked_species_list <- species_list %>% 
  rename(spec.name = species) %>% 
  WFO.match.fuzzyjoin(WFO.file = "../../1_data/TRY_data/classification.csv")
```
